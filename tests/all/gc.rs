...
/// externref params (more than fit in registers) and multi-value externref
/// results (more than fit in registers, forcing the return area, whose layout
/// is shared with Cranelift-compiled trampolines). A collection is forced
/// while all of them are live.
#[test]
#[cfg_attr(miri, ignore)]
