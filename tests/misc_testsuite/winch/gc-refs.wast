...
;; barrier-free collectors; the deferred reference-counting collector is
;; refused at config time until Winch emits barriers.
...
(module
  ...
  (func (export "roundtrip") (param externref) (result externref)
    ...
    ;; hold the local across a call: exercises the stack map
    (call $nop)
    (local.get $l))
